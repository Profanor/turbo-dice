...
interface TabContentProps {
  ...
  topPlayers: { [key: string]: Array<{ date: string; avatar: string; betAmount: number; winAmount: number; round: number }> };
  myBetsSubTab: string;
  topSubTab: string;
...
export const TabContent: React.FC<TabContentProps> = ({ activeTab, ongoingBets, endedBets, topPlayers, 
  myBetsSubTab, setMyBetsSubTab, topSubTab, setTopSubTab, leaderboard }) => {
